...
window.onload = function() {
    ...
    g.addNode("f20", {render:render});
    g.addNode("f21", {render:render});

    /* connections */
    g.addEdge("cycle1", "cycle2", {label:9});
    g.addEdge("cycle1", "f13", {label:5});

    g.addEdge("cycle2", "f14", {label:4});
    g.addEdge("cycle2", "f15", {label:10});

    g.addEdge("cycle3", "f15", {label:3});

    g.addEdge("f13", "f14", {label:5});
    g.addEdge("f13", "f18", {label:7});

    g.addEdge("f14", "f18", {label:3});

    g.addEdge("f15", "f16", {label:11});
    g.addEdge("f15", "f19", {label:4});

    g.addEdge("f16", "f17", {label:7});

    g.addEdge("f17", "f19", {label:5});
    g.addEdge("f17", "f20", {label:4});

    g.addEdge("f18", "f19", {label:8});
    g.addEdge("f18", "f21", {label:5});

    g.addEdge("f19", "f20", {label:3});
