...
window.onload = function() {
    ...
    /* connections */
    g.addEdge("cycle1", "cycle2", {label:7});
    g.addEdge("cycle1", "f14", {label:1});

    g.addEdge("cycle2", "cycle3", {label:1});
    g.addEdge("cycle2", "f13", {label:2});

    g.addEdge("cycle3", "f14", {label:4});

    g.addEdge("f13", "f14", {label:3});
